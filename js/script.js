...
Webflow.require('ix2').init({
	"events": {
		"e": {
			...
			"target": {
				"id": "7f8044ba-9586-1124-c965-b708db69ca21",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-31": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "62f5ed2732fbd65a72546439|9eb19ee5-421c-a040-7be4-4ed3255e6c6b",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
	...
	"actionLists": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["fe647bb1-318c-4955-860a-0060fbe21fd7"]
						},
						"widthValue": 0,
						"widthUnit": "px",
						"heightUnit": "PX",
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["fe647bb1-318c-4955-860a-0060fbe21fd3"]
						},
						"yValue": -8,
						"xUnit": "PX",
						"yUnit": "px",
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["fe647bb1-318c-4955-860a-0060fbe21fe1"]
						},
						"yValue": 8,
						"xUnit": "PX",
						"yUnit": "px",
		...
		"a-19": {
				...
				"continuousActionGroups": [{
					...
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".logo4_wrapper",
								"selectorGuids": ["238c2f1f-4311-65b4-d615-c5ce837014ed"]
							},
							"xValue": 0.5,
							"yValue": 0.5,
							"locked": true
			...
			"createdOn": 1646218907718
		},
		"a-22": {
			"id": "a-22",
			"title": "generic-hero-load",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-22-n-3",
					"actionTypeId": "STYLE_SIZE",
					"config": {
						...
						"duration": 500,
						"target": {
							"selector": ".h1-hero-load",
							"selectorGuids": ["86983c99-d6a2-5230-7ec4-bd519321009d"]
						},
						"heightValue": 0,
						"widthUnit": "PX",
						"heightUnit": "px",
					...
					"config": {
						...
						"target": {
							"selector": ".hero-arrow",
							"selectorGuids": ["5c28ac73-5198-38fd-d8e7-0fb671dfd421"]
						},
						"heightValue": 0,
						"widthUnit": "PX",
						"heightUnit": "px",
			...
			"createdOn": 1646220158106
		},
		"a-11": {
			"id": "a-11",
			"title": "about-scrolling-endless-loop",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-11-n",
					"actionTypeId": "TRANSFORM_MOVE",
					"config": {
						...
						"duration": 0,
						"target": {
							"selector": ".about-scrolling_component",
							"selectorGuids": ["04516a30-75a8-98d6-db73-67236a930f4c"]
						},
						"xValue": 0,
						"xUnit": "px",
						"yUnit": "PX",
